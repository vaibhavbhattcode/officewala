  ...
  return (
    <InfoPageLayout title="Disclaimer" subtitle="Legal & Fair Use Statement">
      <div className="space-y-6 text-white/80">
        <p>
          If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at <em>hello@musicwala.life</em>.
        </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            If you are the copyright owner of any track or background video listed on this station and wish to request its removal, please contact us at <em>hello@musicwala.life</em> with proper proof of ownership, and we will remove the content from our playlist index immediately (within 24-48 hours).
          </p>
        </section>
